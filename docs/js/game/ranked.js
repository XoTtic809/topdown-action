...
const RANKED_CONFIG = {
  bronze: {
    ...
    desc:'7 waves, basic enemies. Learn the ropes.',
  },
  silver: {
    ...
    desc:'Fast enemies show up. Boss fight on wave 8.',
  },
  gold: {
    ...
    desc:'Tanks start spawning. Mini-boss on wave 5 and 10.',
  },
  platinum: {
    ...
    desc:'Shooters added. 12 waves with a mini-boss every 4.',
  },
  diamond: {
    ...
    desc:'Enforcers can dash at you. 200 RP per division, wins and losses hit equal.',
  },
  master: {
    ...
    rpGainBase:10, rpLoss:12, rpPerWave:2, streakCap:0.20,
    enemyTypes:['normal','fast','tank','shooter','enforcer','splitter','bomber'],
    miniBossInterval:5, bigBossInterval:15,
    desc:'Splitters and bombers in the mix. 700 RP to promote, losses cost more than wins give.',
  },
  grandmaster: {
    ...
    rpGainBase:10, rpLoss:14, rpPerWave:2, streakCap:0.20,
    enemyTypes:['normal','fast','tank','shooter','enforcer','splitter','bomber','phantom'],
    miniBossInterval:4, bigBossInterval:16,
    desc:'Phantoms go invisible. 900 RP to reach Apex, you need a win streak to climb.',
  },
  apex: {
    ...
    rpGainBase:12, rpLoss:16, rpPerWave:2, streakCap:0.25,
    enemyTypes:['normal','fast','tank','shooter','enforcer','splitter','bomber','phantom'],
    miniBossInterval:4, bigBossInterval:16,
    desc:'Top 100 players. Every enemy type, 16 waves. Hold your spot or get knocked down.',
  },
  sovereign: {
    ...
    targetWaves:16, waveOffset:0,
    hpMult:1.05, speedMult:1.0,
    rpGainBase:14, rpLoss:18, rpPerWave:2, streakCap:0.25,
    enemyTypes:['normal','fast','tank','shooter','enforcer','splitter','bomber','phantom'],
    miniBossInterval:4, bigBossInterval:16,
    desc:'Rank #1. Highest RP Apex player takes this spot automatically.',
  },
};
